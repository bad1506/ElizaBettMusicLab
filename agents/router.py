...
def invoke(
    ...
    *,
    ...
    system = (
        ...
        "и vocal events. Если нужен общий вердикт по миксу, после read-only диагностики при необходимости "
        "используй music.analyze_mix или music.build_advice. Не выдавай оценочные алгоритмические метки за "
